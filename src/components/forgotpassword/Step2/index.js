      ...
      <KeyboardAvoidingView behavior="position" style={styles.container}>
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.text}>
            Informe o código de 6 digitos que foi enviado para {email} para prosseguir...
          </Text>
          ...
          <TouchableOpacity disabled={enableLink} onPress={resendCode}>
            {enableLink ? (
              ...
              <Text style={styles.linkText}>Solicitar outro código</Text>
            )}
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.inputGroup}>
          ...
          {!loading ? (
            <Button text="Prosseguir" enabled={enableButton} color="#774DD6" action={nextStep} />
          ) : (
            <Button>
