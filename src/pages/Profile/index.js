      ...
      <KeyboardAwareScrollView style={styles.container} resetScrollToCoords={{ x: 0, y: 0 }}>
        <View style={styles.header}>
          <BorderlessButton onPress={goToLandingPage}>
            <Ionicons name="arrow-back" size={24} color="#D4C2FF" />
          </BorderlessButton>
        ...
        <View style={styles.pictureContainer}>
          <Image style={styles.picture} source={{ uri: userData.avatar_url }}></Image>
        ...
        <LinearGradient colors={['#F0F0F7', '#EBEBF5', '#E6E6F0']} style={styles.content}>
          <ScrollView
            style={{ marginTop: -40 }}
          ...
          >
            <View style={styles.dataContainer}>
              ...
              <TouchableOpacity onPress={goToDeleteAcconuntPage}>
                <Text style={[styles.linkText, { color: 'red' }]}>Excluir conta</Text>
              </TouchableOpacity>
