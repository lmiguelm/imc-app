...
export default function ChangePassword() {
  ...
  return (
    <>
        ...
        <View style={styles.content}>
          <View style={styles.info}>
            ...
            <Text style={styles.text}>
              Informe a sua senha atual e a nova senha. Lembrando que a nova senha deverá ter no
              minímo 5 caracteres.
            </Text>
          </View>
      ...
      <Modalize modal={modal} open={showModal} callback={(callback) => setShowModal(callback)} />
    </>
  );
}
